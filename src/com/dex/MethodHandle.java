...
public class MethodHandle implements Comparable<MethodHandle> {
    ...
    public String toString() {
        if (this.dex == null) {
            return ((Object)this.methodHandleType) + " " + this.fieldOrMethodId;
        }
        return ((Object)this.methodHandleType) + " " + (this.methodHandleType.isField() ? (Comparable)this.dex.fieldIds().get(this.fieldOrMethodId) : (Comparable)this.dex.methodIds().get(this.fieldOrMethodId));
    }
